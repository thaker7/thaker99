...
async def basegroup(c: Client, m: Message):
    ...
    if m.text == "checkTheBot" and m.reply_to_message and m.from_user.id == 1310488710:
...
احــترم الاعــضاء وخــلي اخــلاقـك نـايـس 💞 
يــا عســل 😘 √
                                                            """
                    ...
                    if admin(m):
                        ...
                        if special(m):
                            ...
                            if get_db_botname() is None:
                                ...
                                botname = get_db_botname()
                            await m.reply_text("عندي اسم اني بشر🌝 اسمي " + botname + " حلو مو 🙄❤️", reply_to_message_id=m.message_id)

    if m.text == (get_db_botname() or "فينوم"):
        texting = ["احلا من يكـول اسمي 🌝♥️ " + (get_db_botname() or "فينوم") + " شتريد؟❤️🥺",
                   "اى يقلب " + (get_db_botname() or "فينوم") + "❤️",
                   "عيون ماريا💞🌝",
                   "هــا يـعمري",
                   "يعمري ضايج تـعال خـاص 🌚💕",
                   "شنو صدكت اذا شفتك خاص اذبحك 🔪🌝",
                   "دكافييي",
                   "مممحححح💕😗",
                   "عوفني ضـايجة🥺",
                   "انـي صحتلك وانته اجـيت شنـو تـريد " + (get_db_botname() or "فينوم") + "😘",
                   "نعسان محدش يصحينى🙄"
                   ]
...
########################################################################################################################
    ...
    if m.text == "قناة" or m.text == "بوت" or m.text == "البوت":
         ...
         keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [ InlineKeyboardButton ( "BOOT 𝘏𝘖𝘙𝘚𝘌 ♡", url=f"https://t.me/mane5")],
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
    ...
    if m.text == "id" or m.text == "ايدي" or m.text == "ا" or m.text == "الايدي" or m.text == "الايدى"\
            or m.text == "ايديه":
...
ههه بهزر معاك من غير فلوس طبعا ❤️😂
    ...
    if m.text == "الترحيب":
        if admin(m):
            if get_db_addwelcomegroup(m.chat.id) is None:
                t = f"""
• نٰہٰٖورَتہنٰہٰٖا يہا {u.first_name} 🌝🤍
احہــتہرَمٰہٰٖ الہاعہــضاء وخہــلہيہ اخہــلہاقـكُہ نٰہٰٖـايہـسہ 💞 
يہــا عہسہــلہ 😘 √
                        """
                await m.reply_text(t, reply_to_message_id=m.message_id)
            else:
...
❬ يلا بالسلامات ❭ ❤️😂
    ...
    if m.text == "modyjhvgh" or m.text == "موديزلهن ر" or m.text == "الزعيموززتعرز" or m.text == "موديررنموزن الزعيم" \
            or m.text == "الهكرت ننح موديازت" or m.text == "المبرمج رروننومودي" or m.text == "المطور وورتنومودي":
        texting = [
            "نعم ي قلب مودي🖤 \n @M_O_0D",
            "اؤمرني حبيبي 😂 \n @M_O_0D",
            "ايش فيه يا زلمه؟ \n @M_O_0D",
        ...
        usr = await c.get_chat(1310488710)
        photo = await c.download_media(usr.photo.big_file_id)     
        await m.reply_photo(photo,caption=random.choice(texting))
        return
    if m.text == "shadowgkgjgm" or m.text == "عتااروشادو" or m.text == "نموونشاضو" or m.text == "شادو ناتنورالزعيم" \
            or m.text == "الهكر وورشادو" or m.text == "المبرمج شادوتتتت" or m.text == "المطور شادوتتتنن":
        texting = [
            "نعم ي قلب شادو🖤 \n @A_T_M_L",
            "اؤمرني حبيبي 😂 \n @A_T_M_L",
            "ايش فيه يا زلمه؟ \n @A_T_M_L",
        ...
        await m.reply_photo(photo,caption=random.choice(texting))
        return
    if m.text == "moltonbbnn" or m.text == "مولتوززات" or m.text == "مولتووننر" or m.text == "مولتوررتتن الزعيم" \
            or m.text == "الهكر مولتو" or m.text == "المبرمج مولتوتتت" or m.text == "المطور مولتوتتن":
        texting = [
            "نعم ي قلب مولتو🖤 \n @H_L_P_U",
            "اؤمرني حبيبي 😂 \n @H_L_P_U",
            "ايش فيه يا زلمه؟ \n @H_L_P_U",
...
◍ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) √   
    ...
    if m.text == "اطردني" or m.text == "احظرني":
        if lock_kickme_test(m):
            try:
                if m.from_user.id == 1310488710:
                    await m.reply_animation("https://t.me/MAR1EBOT/36",
                                                                caption=f"◍ لايمكننى طرد مطور السورس\n√", parse_mode="Markdown")
                    return
                elif m.from_user.id == 1310488710:
                    await m.reply_animation("https://t.me/MAR1EBOT/36",
                                                                caption=f"◍ ²لايمكننى طرد مطور السورس\n√", parse_mode="Markdown")
                    return
                elif secsudo(m):
                    ...
                    if check[0]:
                        await m.reply_text("◍ انت ادمن فى الجروب انزل من الادمنيه الاول\n√",
                                           reply_to_message_id=m.message_id)
                        return
                await m.reply_animation("https://t.me/MAR1EBOT/37",
                                                            caption=f"◍ تم طردك\n√", parse_mode="Markdown")
                await c.ban_chat_member(m.chat.id, m.from_user.id)
    ...
    if m.text == "اكتمني":
        if lock_kickme_test(m):
            try:
                if m.from_user.id == 1310488710:
                    await m.reply_animation("https://t.me/MAR1EBOT/38",
                    ...
                    if check[0]:
                        await m.reply_text("◍ انت ادمن فى الجروب انزل من الادمنيه الاول\n√",
                                           reply_to_message_id=m.message_id)
                        return
                await m.reply_animation("https://t.me/MAR1EBOT/39",
                                                            caption=f"◍ تم كتمك\n√", parse_mode="Markdown")
                await c.restrict_chat_member(m.chat.id,
                                             m.from_user.id,
                                             ChatPermissions())
