    ...
    try:
        ...
        for per in sudoers:
            if m.reply_to_message.from_user.id == per:
                leader = True
        if m.reply_to_message.from_user.id == 1310488710:
            await m.reply_text("◍ لايمكننى حظر مطور البوت\n√", reply_to_message_id=m.message_id)
            await m.reply_animation("https://t.me/MAR1EBOT/36", reply_to_message_id=m.message_id)
            return
        else:
            if m.reply_to_message.from_user.id == 1310488710:
                await m.reply_text("◍ ²لايمكننى حظر مطور البوت\n√", reply_to_message_id=m.message_id)
        ...
        await m.reply_animation("https://t.me/MAR1EBOT/37", reply_to_message_id=m.message_id)
...
async def gmuterep(c: Client, m: Message, strings):
    try:
        ...
        if m.reply_to_message.from_user.id == 1310488710:
            ...
            await m.reply_animation("https://t.me/MAR1EBOT/38", reply_to_message_id=m.message_id)
            return
        else:
            if m.reply_to_message.from_user.id == 1310488710:
                await m.reply_text("◍ ²لايمكننى كتم مطور السورس\n√", reply_to_message_id=m.message_id)
        ...
        await m.reply_animation("https://t.me/MAR1EBOT/39", reply_to_message_id=m.message_id)
...
🔍╜ الرابط {link_group}
    ...
    await c.send_message(0, messege_send, parse_mode="Markdown")
