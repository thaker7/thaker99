...
async def Client_start(c:Client,m:Message):
	...
	if do.count("left") or do.count("Bad Request: user not found") or is_user(id=user) and not is_band(user):
		...
		await Client.send_message(text=f"Hi {m.from_user.mention}",
	      chat_id = m.chat.id, 
	...
	if (not is_user(id=str(user))):
		...
		try:
			await Client.send_message(owner,New_Member.format(mm,user,cc),
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("دخول لحسابه",
			user_id=int(user))]]))
		except:
			await Client.send_message(owner,"**دخل عضو جديد للبوت ولم استطع تحديد معلوماته √**")
...
@Client.on_message(filters.command("•---- حذف الكيبورد -----•","")&filters.private)
...
@Client.on_message(filters.command("^نسخه الكل$","")&filters.private)
...
@Client.on_message(filters.command("^عرض المجموعات$","")&filters.private)
...
@Client.on_message(filters.command("^نسخه المجموعات$","")&filters.private)
...
@Client.on_message(filters.command("^عدد المجموعات$","")&filters.private)
...
@Client.on_message(filters.command("^روابط المجموعات$","")&filters.private)
...
#-----------------------BanUser---------------------------	
@Client.on_message(filters.command("^نسخه المحظورين$","")&filters.private)
...
@Client.on_message(filters.command("^عدد المحظورين$","")&filters.private)
...
@Client.on_message(filters.command("عرض المطورين الاساسيين","")|filters.command("عرض الاساسيين","") &filters.private)
...
@Client.on_message(filters.command("^نسخه الاساسيين$","")&filters.private)
...
@Client.on_message(filters.command("^عدد الاساسيين$","")&filters.private)
...
@Client.on_message(filters.command("^عرض المطورين$","")&filters.private)
...
@Client.on_message(filters.command("^عدد المطورين$","")&filters.private)
...
@Client.on_message(filters.command("^نسخه المطورين$","")&filters.private)
...
@Client.on_message(filters.command("^عرض الاعضاء$","")&filters.private)
...
@Client.on_message(filters.command("^نسخه الاعضاء$","")&filters.private)
...
@Client.on_message(filters.command("^عدد الاعضاء$","")&filters.private)
...
@Client.on_message(filters.command("اضف قناة اشتراك اجباري","")&filters.private)
...
@Client.on_message(filters.command("عرض قناة الاشتراك","")&filters.private)
...
@Client.on_message(filters.command("حذف قناه الاشتراك","")&filters.private)
...
#--------------------------------------------------------------
#-----------------------DevChannel---------------------
@Client.on_message(filters.command("اضافه قناه المطور","")&filters.private)
...
@Client.on_message(filters.command("عرض قناة المطور","")&filters.private)
...
@Client.on_message(filters.command("حذف قناه المطور","")&filters.private)
...
#--------------------------------------------------------------
#-----------------------DevUser-------------------------
@Client.on_message(filters.command("اضافه معرف المطور","")&filters.private)
...
@Client.on_message(filters.command("عرض معرف المطور","")&filters.private)
...
@Client.on_message(filters.command("حذف معرف المطور","")&filters.private)
...
@Client.on_message(filters.command("رفع مالك",prefixes="")&filters.private)
	...
	if (user) in owner or int(user) == dev_owner:
		...
		if ask.text == "الغاء":
			...
			if(not is_main_dev(str(inputText))):
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم رفعك مالك البوت**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
...
#-------------------------------------------------------------
#------------------------DelOwner-----------------------
@Client.on_message(filters.command("تنزيل مالك",prefixes="")&filters.private)
	...
	if (user) in owner or int(user) == dev_owner:
		...
		if inputText =="الغاء":
			...
			await m.reply("**تم الالغاء**")
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم حذفك من المالكين**",
...
@Client.on_message(filters.command("المالكين","") &filters.private)
...
#-------------------------------------------------------------
#----------------------DelAllOwner---------------------
@Client.on_message(filters.command("حذف المالكين","")&filters.private)
...
#-------------------------------------------------------------
#-------------------------AddMain------------------------
@Client.on_message(filters.command("رفع مطور اساسي",prefixes="")&filters.private)
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner:
		...
		if ask.text == "الغاء":
			...
			if(not is_main_dev(str(inputText))):
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم رفعك مطور اساسي في البوت**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
url=f"https://t.me/{show_devchannel()}")]])
					)
				except:
					pass
...
#-------------------------------------------------------------
#-------------------------DelMain-----------------------
@Client.on_message(filters.command("تنزيل مطور اساسي",prefixes="")&filters.private)
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		if inputText =="الغاء":
			...
			await m.reply("**تم الالغاء**")
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم حذفك من المطوريين الاساسيين**",
					reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
url=f"https://t.me/{show_devchannel()}")]])
					)
				except:
...
#-------------------------------------------------------------
#-----------------------DelAllMain---------------------
@Client.on_message(filters.command("حذف الاساسيين","")&filters.private)
...
#-------------------------------------------------------------
#-------------------------AddSudo------------------------
@Client.on_message(filters.command("رفع مطور",prefixes="")&filters.private)
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		if ask.text == "الغاء":
			...
			if(not is_main_dev(str(inputText))):
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم رفعك مطور في البوت**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
url=f"https://t.me/{show_devchannel()}")]])
					)
				except:
					pass
...
#-------------------------------------------------------------
#-------------------------DelSudo-----------------------
@Client.on_message(filters.command("تنزيل مطور",prefixes="")&filters.private)
	...
	if str(user) in mainSudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		if inputText =="الغاء":
			...
			await m.reply("**تم الالغاء**")
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم حذفك من المطوريين**",
					reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
url=f"https://t.me/{show_devchannel()}")]])
					)
				except:
...
#-------------------------------------------------------------
#------------------------DelAllSudo---------------------
@Client.on_message(filters.command("حذف المطورين","")&filters.private)
...
@Client.on_message(filters.command("الغاء حظر عضو",prefixes="")&filters.private)
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner: 
		...
		if inputText == "الغاء":
			...
			if(not is_band(str(inputText))):
				...
				try:
					await Client.send_message(int(inputText),"**مرحبا عزيزي تم الغاء حظرك من البوت**",
					reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("قناة السورس",
url=f"https://t.me/{show_devchannel()}")]])
					)
				except:
...
@Client.on_message(filters.command("عرض المحظورين","")&filters.private)
...
@Client.on_message(filters.command("حذف المحظورين","")&filters.private)
...
#--------------------------AllBroadCast--------------------	
@Client.on_message(filters.command("اذاعه للكل",prefixes=""))
...
#---------------------Not Togeh----------------------------------
@Client.on_message(filters.command("اذاعه الاعضاء",prefixes=""))
...
url=f"https://t.me/{show_devchannel()}")]])
			...
			await Client.send_message(chat,f"**تم الاذاعه الي **: \n {us} من الاعضاء")

@Client.on_message(filters.command("اذاعه المحظورين",prefixes=""))
...
@Client.on_message(filters.command("اذاعه المجموعات",prefixes=""))
async def memcommands__(c,m):
	user = m.from_user.id
	chat = m.chat.id
	mainSudo = open(f"maindevs{bot_id}.json","r").read()
...
@Client.on_message(filters.command("توجيه للكل",prefixes=""))
async def AllCommand__(c,m):
	user = m.from_user.id
	chat = m.chat.id
	mainSudo = open(f"maindevs{bot_id}.json","r").read()
	...
	if str(user) in mainSudo or str(user) in sudo or str(user) in mainSudoVII or (user) in owner or int(user) == dev_owner:
		...
		if inputText == "الغاء":
			...
			await Client.send_message(chat,f"**تم الاذاعه بالتوجيه الي** : \n\n {x1} من الأعضاء \n {x2} من المحظورين \n {x3} من المجموعات")
		
#---------------------------YupTogeh---------------------------
@Client.on_message(filters.command("توجيه الاعضاء",prefixes=""))
async def memcommands__(c,m):
	user = m.from_user.id
	chat = m.chat.id
	mainSudo = open(f"maindevs{bot_id}.json","r").read()
...
@Client.on_message(filters.command("توجيه محظورين",prefixes=""))
async def memcommands__(c,m):
	user = m.from_user.id
	chat = m.chat.id
	mainSudo = open(f"maindevs{bot_id}.json","r").read()
...
@Client.on_message(filters.command("توجيه المجموعات",prefixes=""))
async def memcommands__(c,m):
	user = m.from_user.id
	chat = m.chat.id
	mainSudo = open(f"maindevs{bot_id}.json","r").read()
